        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-2 bg-gray-700 border border-gray-600 text-gray-300 rounded"
            />
            {errors.file && (
          ...
          <div className="flex gap-4 mb-4">
            <div className="flex-1">
              ...
              <input
                ...
                className="mt-2 p-2 w-full bg-gray-700 border border-gray-600 text-gray-300 rounded"
              />
              {errors.firstName && (
          ...
          <button
            type="submit"
            className="bg-blue-500 text-gray-900 px-4 py-2 rounded hover:bg-blue-600"
          >
            Submit
          </button>
        </form>
